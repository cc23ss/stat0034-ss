...
## Formulation of the Tobit-2 log-likelihood, which will be used in order to 
...
## Example 1 - Profile Likelihood, applied onto 

We use this example from Rubio (2024a) as an example for w
