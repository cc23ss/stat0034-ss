...
#WARNING: Each graph takes a long time (5-10 minutes) to plot. Execute at your
#own risk. 
prof4 = Vectorize(function(par) prof.lik(parint = par, ind = 4, init = "MLE"))
curve(prof4, 0.15, 0.26, n = 50, lwd = 1, xlab = expression(beta[1]), 
      ylab = "Profile Likelihood",
...
curve(prof5, 0.2, 0.5 , n = 50, lwd = 1, xlab = expression(beta[2]), 
      ylab = "Profile Likelihood",
...
curve(prof6, -0.04, 0.08 , n = 50, lwd = 1, xlab = expression(beta[3]), 
      ylab = "Profile Likelihood", 
...
curve(prof7, -0.5,0.1 , n = 50, lwd = 1, xlab = expression(beta[4]), 
      ylab = "Profile Likelihood", 
...
curve(prof8, 0.44, 0.64 , n = 50, lwd = 1, xlab = expression(beta[5]), 
      ylab = "Profile Likelihood", 
...
curve(prof9, -0.15, 0.15 , n = 50, lwd = 1, xlab = expression(beta[6]), 
      ylab = "Profile Likelihood", 
...
curve(prof10, -1.5, 0.5 , n = 50, lwd = 1, xlab = expression(alpha[0]), 
      ylab = "Profile Likelihood", 
...
curve(prof11, 0, 0.18, n = 50, lwd = 1, xlab = expression(alpha[1]), 
      ylab = "Profile Likelihood", 
...
curve(prof12, 0.2, 1 , n = 50, lwd = 1, xlab = expression(alpha[2]), 
      ylab = "Profile Likelihood", 
...
curve(prof13, 0, 0.2, n = 50, lwd = 1, xlab = expression(alpha[3]), 
      ylab = "Profile Likelihood", 
...
curve(prof14, -0.6, -0.1 , n = 50, lwd = 1, xlab = expression(alpha[4]), 
      ylab = "Profile Likelihood", 
...
curve(prof15, 0.4, 1.2, n = 50, lwd = 1, xlab = expression(alpha[5]), 
      ylab = "Profile Likelihood", 
...
curve(prof16, -0.2, 0.4, n = 50, lwd = 1, xlab = expression(alpha[6]), 
      ylab = "Profile Likelihood", 
...
curve(prof17, -0.01, 0.01, n = 50, lwd = 1, xlab = expression(alpha[7]), 
      ylab = "Profile Likelihood", 
...
#Getting the reference values as defined in Cole (2020) and in Chapter 5 of 
#the Dissertation.
