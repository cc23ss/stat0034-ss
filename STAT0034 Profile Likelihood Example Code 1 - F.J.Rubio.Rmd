...
#as rho is squared within our log-likelihood, we evaluate the Tobit-2 
#log-likelihood within the range [0, 1]. 
sigma.test = exp(MLE[1])
...
#loglik.Tobit2
i = 1
#Initiate a for loop for rho in [0, 1], iterating over seq(0,1, 
#length.out = no.steps).
...
loglik.Tobit2
#Plotting our results here. Very interestingly, it doesn't seem like
#the correlation matters much to the log-likelihood until we reach 
#unity/determinism, and at that point our sample becomes absurdly unlikely. 
#Note that our y-axis is in log-scale. 

#Try to do beta/sigma reparametrisation. 

#Relative likelihood
plot(loglik.Tobit2, x = seq(-1, 1, length.out = no.steps), 
