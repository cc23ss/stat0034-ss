...
curve(prof1degen, n = 100, from = 0.01, to = 1.1, ylab = "Profile Likelihood", 
      xlab = expression(sigma), main = expression(paste()))
...
curve(prof1, n = 100, from = 3, to = 5, ylab = "Profile Likelihood", 
      ...
      main = expression(paste("Profile Likelihood for ", sigma)))
abline(v = OPT$MLE[1], col = "red", lwd = 2)
legend(x = "topleft", legend = c("MLE"), pch = 16, col = "red")
...
prof2 = Vectorize(function(par) prof.lik(parint = atanh(par), ind = 2, 
                                          init = "MLE", method = "CG"))
curve(prof2, n = 100, from = 0.9, to = 0.9999, ylab = "Profile Likelihood", 
      xlab = expression(rho), 
...
prof3 = Vectorize(function(par) prof.lik(parint = par, ind = 3, init = "MLE",
                                         method = "nlminb"))
curve(prof3, n = 100, from = -11, to = -9, ylab = "Profile Likelihood", 
...
prof5 = Vectorize(function(par) prof.lik(parint = par, ind = 5, init = "MLE",
                                         method = "nlminb"))
curve(prof5, n = 100, from = -0.02, to = 0.02, ylab = "Profile Likelihood", 
...
prof6 = Vectorize(function(par) prof.lik(parint = par, ind = 6, init = "MLE",
                                         method = "nlminb"))
curve(prof6, n = 200, from = -0.0002, to = 0.0001, ylab = "Profile Likelihood", 
...
prof7 = Vectorize(function(par) prof.lik(parint = par, ind = 7, init = "MLE",
                                         method = "nlminb"))
curve(prof7, n = 100, from = -1, to = 0.5, ylab = "Profile Likelihood", 
...
#e.g. of challenging optimisation here.
# prof8alt = Vectorize(function(par) prof.lik(parint = par, ind = 8, init = "MLE",
#                                          method = "BFGS"))
# curve(prof8alt, n = 100, from = 0.5, to = 0.7, ylab = "Profile Likelihood", 
#       xlab = expression(beta[5]),
#       main = expression(paste("Profile Likelihood for ", beta[5])))
...
prof10 = Vectorize(function(par) prof.lik(parint = par, ind = 10, init = "MLE",
                                         method = "nlminb"))
curve(prof10, n = 100, from = -0.05, to = 0.05, ylab = "Profile Likelihood", 
...
prof11 = Vectorize(function(par) prof.lik(parint = par, ind = 11, init = "MLE",
                                         method = "nlminb"))
curve(prof11, n = 100, from = -0.001, to = 0.001, ylab = "Profile Likelihood", 
...
prof12 = Vectorize(function(par) prof.lik(parint = par, ind = 12, init = "MLE",
                                         method = "nlminb"))
curve(prof12, n = 100, from = 0.1, to = 0.2, ylab = "Profile Likelihood", 
...
prof13 = Vectorize(function(par) prof.lik(parint = par, ind = 13, init = "MLE",
                                         method = "nlminb"))
curve(prof13, n = 100, from = -0.5, to = 0.5, ylab = "Profile Likelihood", 
...
confint2.proflink = c(LPVec[1], UPVec[1])
