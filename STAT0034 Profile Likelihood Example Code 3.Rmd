...
curve(prof1degen, n = 100, from = 0.01, to = 1, ylab = "Profile Likelihood", 
...
#Implementing the profile likelihood based interval for sigma.
...
intprof1 = Vectorize(function(par) prof2(par) - bound)
curve(intprof1, n = 100, from = 4, to = 5)
abline(h = 0.147)

LP = uniroot(f = intprof2, interval = c(0.9, 0.99))$root
UP = uniroot(f = intprof2, interval = c(0.991, 0.996))$root
